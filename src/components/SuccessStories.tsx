...
const stories = [{
  ...
  image: "/lovable-uploads/fdb1f7a9-8acc-47fe-8db5-22ca16c9f4e3.png",
  // Corrected path by removing "public"
  client: {
    name: "Marco Rossi",
  ...
  image: "/lovable-uploads/b5e3c5ca-0e17-4fc7-b6c2-01c4da7e8876.png",
  // Updated with new satellite imagery
  client: {
    name: "Laura Bianchi",
  ...
  image: "/lovable-uploads/9a130aea-4197-40af-a0e1-ae787cfa0226.png",
  // Corrected path by removing "public"
  client: {
    name: "Antonio Verdi",
...
const SuccessStories = () => {
  return <section id="success-stories" className="section bg-white">
      <div className="container-custom">
        <div className="section-header">
          <h2 className="text-secondary">Success Stories</h2>
          <p className="text-xl">Companies that have transformed their business through Discovery One</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {stories.map((story, index) => <Card key={index} className="overflow-hidden border-0 hover:-translate-y-2 transition-all duration-300 hover:shadow-xl">
              <div className="h-52 overflow-hidden">
                <img src={story.image} alt={story.title} className="w-full h-full object-cover transition-all duration-500 hover:scale-110" />
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
                    <img src={story.client.image} alt={story.client.name} className="w-full h-full object-cover" />
                  </div>
                  <div>

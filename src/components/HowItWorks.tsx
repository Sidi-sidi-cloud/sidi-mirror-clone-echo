...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" className="section bg-light">
      ...
      <div className="mt-12 mb-16">
            <div className="flex flex-col space-y-12">
              {steps.map((step, index) => <div key={step.number} className="flex flex-col items-center">
                  ...
                  {index < steps.length - 1 && <div className="mt-6">
              ...
              <div className="relative grid grid-cols-5 gap-4">
                {steps.map((step, index) => <div key={step.number} className="flex flex-col items-center">
                    ...
                    <div className="flex items-center mb-8">
                      <div className="w-24 h-24 rounded-full bg-primary flex items-center justify-center text-white font-bold text-4xl px-0 mx-0 my-[16px]">
                        {step.number}
                      </div>
                    </div>
                ...
                {[0, 1, 2, 3].map(index => <div key={`arrow-${index}`} style={{
              left: `calc(${index * 20 + 16.5}%)`,
              width: "7%",
              top: "12px",
              height: "24px",
